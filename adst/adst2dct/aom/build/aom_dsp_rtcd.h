...
void aom_d207_predictor_16x16_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d207_predictor_16x16_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d207_predictor_16x16)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d207_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d207_predictor_2x2 aom_d207_predictor_2x2_c

void aom_d207_predictor_32x32_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d207_predictor_32x32_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d207_predictor_32x32)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d207_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d207_predictor_4x4_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d207_predictor_4x4 aom_d207_predictor_4x4_sse2

void aom_d207_predictor_8x8_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d207_predictor_8x8_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d207_predictor_8x8)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
void aom_d45_predictor_16x16_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d45_predictor_16x16_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d45_predictor_16x16)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d45_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d45_predictor_2x2 aom_d45_predictor_2x2_c

void aom_d45_predictor_32x32_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d45_predictor_32x32_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d45_predictor_32x32)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d45_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d45_predictor_4x4_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d45_predictor_4x4 aom_d45_predictor_4x4_sse2

void aom_d45_predictor_8x8_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d45_predictor_8x8_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d45_predictor_8x8 aom_d45_predictor_8x8_sse2
...
void aom_d63_predictor_16x16_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d63_predictor_16x16_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d63_predictor_16x16)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d63_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d63_predictor_2x2 aom_d63_predictor_2x2_c

void aom_d63_predictor_32x32_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d63_predictor_32x32_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d63_predictor_32x32)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d63_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d63_predictor_4x4_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d63_predictor_4x4)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void aom_d63_predictor_8x8_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_d63_predictor_8x8_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void (*aom_d63_predictor_8x8)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
void aom_d63f_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d63f_predictor_2x2 aom_d63f_predictor_2x2_c

void aom_d63f_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_d63f_predictor_4x4 aom_d63f_predictor_4x4_c
...
void aom_he_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_he_predictor_2x2 aom_he_predictor_2x2_c

void aom_he_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_he_predictor_4x4 aom_he_predictor_4x4_c
...
#define aom_idct16x16_10_add aom_idct16x16_10_add_sse2
...
#define aom_idct16x16_1_add aom_idct16x16_1_add_sse2
...
#define aom_idct16x16_256_add aom_idct16x16_256_add_sse2
...
#define aom_idct32x32_1_add aom_idct32x32_1_add_sse2
...
uint64_t aom_sum_squares_2d_i16_c(const int16_t *src, int stride, int size);
...
void aom_tm_predictor_16x16_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_tm_predictor_16x16_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_tm_predictor_16x16 aom_tm_predictor_16x16_sse2

void aom_tm_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_tm_predictor_2x2 aom_tm_predictor_2x2_c

void aom_tm_predictor_32x32_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_tm_predictor_32x32_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_tm_predictor_32x32 aom_tm_predictor_32x32_sse2

void aom_tm_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_tm_predictor_4x4_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_tm_predictor_4x4 aom_tm_predictor_4x4_sse2

void aom_tm_predictor_8x8_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void aom_tm_predictor_8x8_sse2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_tm_predictor_8x8 aom_tm_predictor_8x8_sse2
...
void aom_ve_predictor_2x2_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_ve_predictor_2x2 aom_ve_predictor_2x2_c

void aom_ve_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
#define aom_ve_predictor_4x4 aom_ve_predictor_4x4_c
...
static void setup_rtcd_internal(void)
{
    ...
    aom_d207_predictor_16x16 = aom_d207_predictor_16x16_c;
    if (flags & HAS_SSSE3) aom_d207_predictor_16x16 = aom_d207_predictor_16x16_ssse3;
    aom_d207_predictor_32x32 = aom_d207_predictor_32x32_c;
    if (flags & HAS_SSSE3) aom_d207_predictor_32x32 = aom_d207_predictor_32x32_ssse3;
    aom_d207_predictor_8x8 = aom_d207_predictor_8x8_c;
    if (flags & HAS_SSSE3) aom_d207_predictor_8x8 = aom_d207_predictor_8x8_ssse3;
    aom_d45_predictor_16x16 = aom_d45_predictor_16x16_c;
    if (flags & HAS_SSSE3) aom_d45_predictor_16x16 = aom_d45_predictor_16x16_ssse3;
    aom_d45_predictor_32x32 = aom_d45_predictor_32x32_c;
    if (flags & HAS_SSSE3) aom_d45_predictor_32x32 = aom_d45_predictor_32x32_ssse3;
    aom_d63_predictor_16x16 = aom_d63_predictor_16x16_c;
    if (flags & HAS_SSSE3) aom_d63_predictor_16x16 = aom_d63_predictor_16x16_ssse3;
    aom_d63_predictor_32x32 = aom_d63_predictor_32x32_c;
    if (flags & HAS_SSSE3) aom_d63_predictor_32x32 = aom_d63_predictor_32x32_ssse3;
    aom_d63_predictor_4x4 = aom_d63_predictor_4x4_c;
    if (flags & HAS_SSSE3) aom_d63_predictor_4x4 = aom_d63_predictor_4x4_ssse3;
    aom_d63_predictor_8x8 = aom_d63_predictor_8x8_c;
    if (flags & HAS_SSSE3) aom_d63_predictor_8x8 = aom_d63_predictor_8x8_ssse3;
